...
|---|---|---|---|---|
| **S1 路線/POI Spike** | 首爾、廣島的 POI 搜尋、分店、步行/大眾運輸/開車時間，比較 MapKit、Apple Maps Server API、韓國在地供應商 | 無 | 實測表（見 §4.4）、供應商建議 | AC-05, 14 |
...
| D3 | 路線/POI 供應商 | Apple 全包 / Apple + 韓國在地供應商 / Google | 成本、韓國覆蓋、授權條款 | **先做 S1 再定**；架構保留 RoutingProvider 抽象 |
...
1. 你回覆第 6 節 D1–D11（可只回有意見的，其餘採建議）。
2. 我啟動 S1–S3 Spike 計畫並把 WP1–WP11 拆成 GitHub Issues。
